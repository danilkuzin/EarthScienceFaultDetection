...
for (preprocessor_ind, data_preprocessor_generator) in enumerate(global_params.data_preprocessor_generators):
    ...
    data_preprocessor.data_io_backend.write_image(
        "training_on_01_long_split_validation/heatmaps_trained_on_01_long_faults_{}_probs.tif".format(preprocessor_ind),
        res_faults*100)
    data_preprocessor.data_io_backend.write_surface(
        "training_on_01_long_split_validation/heatmaps_trained_on_01_long_faults_{}.tif".format(preprocessor_ind),
        res_faults)
