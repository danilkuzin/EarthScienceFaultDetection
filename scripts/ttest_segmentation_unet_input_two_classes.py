...
output_path = f"{data_path}/train_data/regions_{region_ind}_" \
              f"segmentation_mask_rgb_elev_slope_two_classes/"
...
segmentation_mask_np[segmentation_basin_mask_np == 1] = FeatureValue.BASIN_FAULT.value
...
vis_mask.show()
data_io_backend.write_image('test.tif', segmentation_mask_np_vis)
