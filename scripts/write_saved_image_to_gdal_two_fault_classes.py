...
folder = f"{data_path}/results/unet_on_6_rgb_elev_slope_nir_hazmap_one_class_dice_focal_alpha_0.9_semisupervised"
prediction_region = 7
...
# clip_lower = 0.2 # 0.4# 0.3 - hazmap on 6, 0.4 - hazmap on 7
# clip_higher = 0.75 # 0.75 # 0.7 - hazmap on 6, 0.75 - hazmap on 7
