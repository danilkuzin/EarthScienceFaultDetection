...
folder = f"{data_path}/results/unet_on_6_rgb_elev_nir_tri_flow_incision_two_fault_classes_3xlookalike_dice_focal_alpha_0.9_semisupervised"
prediction_region = 7
...
prediction_front_range_probabilities = expit(prediction_front_range)

geotiff_path = folder + f'/prediction_raw_probability_front_range_on_{prediction_region}.tiff'
...
gdal_backend.write_float(geotiff_path, prediction_front_range_probabilities)

geotiff_path = folder + f'/prediction_probability_front_range_on_{prediction_region}_geo_greyscale.tiff'
...
gdal_backend.write_surface(geotiff_path, prediction_front_range_probabilities,
                           colour=False)

plt.imshow(prediction_front_range_probabilities, cmap='gray')
plt.title('front range probability greyscale')
plt.show()
