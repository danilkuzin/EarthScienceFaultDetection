...
callbacks = [
    tf.keras.callbacks.CSVLogger(filename='training_on_01_long_split_validation/log.csv', separator=',', append=False)
]

output_path = "training_on_01_long_split_validation"
