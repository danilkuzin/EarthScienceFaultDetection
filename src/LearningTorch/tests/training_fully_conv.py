...
from src.LearningTorch.net_architecture import cnn_150x150x5_fully_conv_torch
...
model, criterion, optimizer, exp_lr_scheduler = cnn_150x150x5_fully_conv_torch()
...
train_on_preloaded_single_files_torch(
    ...
    folder=f"{data_path}/results/test_training_fully_conv_on_6_torch",
    epochs=10,
